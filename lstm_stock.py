...
x_test = pd.read_csv('x_test_norm_new.csv')
...
def load_y(y_input):
    ...
    return (y_input.values[:]-1)[(input_day_length-1):]
...
class Config(object):
    ...
    def __init__(self, X_train, X_test):
        ...
        self.training_epochs = 40200#1000000
        self.batch_size = 28

        # LSTM structure
        self.n_inputs = len(X_train[0][0])  #7 # Features count is of 9: three 3D sensors features over time
        self.n_hidden = 300  # nb of neurons inside the neural network
        self.n_classes = 2  # Final output classes  6 -> 1
        self.W = {
